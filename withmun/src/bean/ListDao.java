...
public class ListDao {
	...
	public void pageCompute(String findStr) {
		String sql = "select count(serial) cnt from BOARD B where " + " B.name like ? " + " or B.doc like ? ";
	...
	public boolean insert(ListVo vo) {
		boolean b = true;
		String sql = "INSERT INTO BOARD(name, pwd, doc, bdate, reply, grp) VALUES(? , ? , ? , now() , 1 , (select MAX(LAST_INSERT_ID(SERIAL)+1) from BOARD b) )";
