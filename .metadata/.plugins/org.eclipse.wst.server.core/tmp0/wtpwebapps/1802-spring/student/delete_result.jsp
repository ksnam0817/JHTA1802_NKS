...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-30" data-genuitec-path="/1802-spring/WebContent/student/delete_result.jsp">
	<div id='delete_result' data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-30" data-genuitec-path="/1802-spring/WebContent/student/delete_result.jsp">
		<h2>학생정보 삭제 결과</h2>
		${msg }
	</div>
	<p/>
