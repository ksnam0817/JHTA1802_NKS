...
<html>
    ...
    <body class="skin-black" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc3-64" data-genuitec-path="/withmun/WebContent/test.jsp">
        <!-- header logo: style can be found in header.less -->
        <header class="header" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc3-64" data-genuitec-path="/withmun/WebContent/test.jsp">
