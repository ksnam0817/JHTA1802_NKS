<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc3-41" data-genuitec-path="/withmun/WebContent/page/general_translation.jsp">
	<div class="container">
		<div class ="top">
			<a href="./index.jsp" >HOME</a>
			> <a href="">외국어번역행정</a>
			> <a href="">개인</a>
			> <a href="./general_translation.do" class="on">일반번역</a>
		</div>
		<div class="toptit">
		    <h2><a href="./general_translation.do">일반번역</a></h2>
	...
	<%@ include file = "../include/left_foreign.jsp" %>
		<div class = "content">		
			<div class ="content_first">
				<img src="./images/general_translation_topimg.jpg" alt="" style="width:100%;height:100%;">
			</div>
			...
			<div class ="content_second">
					...
					<img src="./images/general_translation.jpg" alt="" style="width:100%; margin-top:60px;">
