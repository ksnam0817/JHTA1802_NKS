...
<div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc3-24" data-genuitec-path="/withmun/WebContent/page/aposcertification_genenal.jsp">
	<div class="container">
		<div class ="top">
			<a href="./index.jsp" >HOME</a>
			> <a href="">외국어번역행정</a>
			> <a href="">개인</a>
			> <a href="./aposcertification_genenal.do" class="on">아포스티유 및 대사관인증</a>
		</div>
		<div class="toptit">
		    <h2><a href="./aposcertification_genenal.do">아포스티유 및 대사관인증</a></h2>
...
<%@ include file = "../include/left_foreign.jsp" %>
		...
		<div class = "content">			
			<div class ="content_first">
			    <img src="./images/aposcertification_genenal_topimg.jpg" alt="" style="width:100%;height:100%;">
			</div>
