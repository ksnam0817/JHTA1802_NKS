...
<div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc3-35" data-genuitec-path="/withmun/WebContent/page/board/list.jsp">
   <div class="container">
      <div class="top">
...
<div class="main">
   <div class="main_wrap">
      ...
      <div class="content">
       ...
       <div id = 'list_word_count'>
     		<input type="text" id="writeNow" value="0" readOnly style="border: 0;width:21px;text-align: right; height: 17px;" />/ 300자
		</div>
   ...
   <!-- 페이징 -->
         ...
         <form name='list_find'>
            ...
            <input type="text" id = 'list_findStr' class="form-control" name="findStr" value="${param.findStr }" title="검색어 입력"
