<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc3-21" data-genuitec-path="/withmun/WebContent/page/acting_translation.jsp">
	<div class="container">
		<div class ="top">
			<a href="./index.jsp">HOME</a>
			> <a href="">외국어번역행정</a>
			> <a href="">기업</a>
			> <a href="./acting_translation.do" class="on">번역공증대행</a>
		</div>
		<div class="toptit">
		    <h2><a href="./acting_translation.do">번역공증대행</a></h2>
	...
	<div class="main_wrap">
		...
		<div class = "content">			
			<div class ="content_first">
				<img src="./images/acting_translation_topimg.jpg" alt="" alt="" style="width:100%;height:100%;">
			</div>
